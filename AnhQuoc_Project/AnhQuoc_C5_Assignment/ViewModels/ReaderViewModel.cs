...
namespace AnhQuoc_C5_Assignment
{
    public class ReaderViewModel : BaseViewModel<Reader>
    {
        ...
        public ObservableCollection<Reader> FillContainIds(ObservableCollection<Reader> source, string valueId, bool igNoreCase, bool? statusValue)
        {
            ...
            foreach (Reader item in source)
            {
                ...
                if (itemDto.Id.ContainsCorrectly(valueId, igNoreCase))
                {
                    newList.Add(item);
                }
            }
