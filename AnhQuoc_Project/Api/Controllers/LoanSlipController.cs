...
namespace Api.Controllers
{
    ...
    public class LoanSlipController : ControllerBase
    {
        ...
        public LoanSlipController(QuanLyThuVienContext quanLyThuVienContext)
        {
        ...
        {
            return Ok(quanLyThuVienContext.LoanSlips.ToList());
        }
        ...
        {
            if (quanLyThuVienContext.LoanSlips.Remove(id) == false)
                return NotFound();
            quanLyThuVienContext.SaveChanges();
