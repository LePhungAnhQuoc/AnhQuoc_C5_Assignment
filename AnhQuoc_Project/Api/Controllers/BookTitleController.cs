...
namespace Api.Controllers
{
    ...
    public class BookTitleController : ControllerBase
    {
        ...
        public BookTitleController(QuanLyThuVienContext quanLyThuVienContext)
        {
        ...
        {
            return Ok(quanLyThuVienContext.BookTitles.ToList());
        }
        ...
        {
            if (quanLyThuVienContext.BookTitles.Remove(id) == false)
                return NotFound();
            quanLyThuVienContext.SaveChanges();
